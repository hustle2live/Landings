...
<div class="icon-container">
   ...
   <img src=".dist/github.ico" alt="github" title="view my github page" width="24" height="24">
   </a>
   <a class="icon-link" href="https://github.com/hustle2live" target="_blank" style="text-decoration:none">
   <img src=".dist/facebook-circle.png" alt="telegram" title="view my facebook page" width="24" height="24">
   </a>
   <a class="icon-link" href="https://github.com/hustle2live" target="_blank" style="text-decoration:none">
   <img src=".dist/telegram-circle.png" alt="telegram" title="write me to telegram" width="24" height="24">
   </a>
</div>
